...
export const PROBLEM_CODE_HARD_STRING = 'okki-i18n-hard-string'
export const PROBLEM_KEY_MISSING = 'okki-i18n-key-missing'
export const PROBLEM_TRANSLATION_MISSING = 'okki-i18n-translation-missing'
