...
export default <ExtensionModule> function() {
  return [
    ...
    commands.registerCommand(Commands.open_i18n_url, async() => {
      await env.openExternal(Uri.parse('https://ezreal.dev.xiaoman.cn/#/i18n'))
    }),

    commands.registerCommand(Commands.open_docs_hard_string, async() => {
      await env.openExternal(
        Uri.parse(
          'https://github.com/lokalise/i18n-ally/wiki/Hard-coded-Strings-Extraction',
        ),
      )
    }),
